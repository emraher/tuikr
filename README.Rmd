...
The goal of `tuikr` is to extract data file and database URLs from [TUIK](https://data.tuik.gov.tr/) webpage. Package can also download data from [Geographical Statistics Portal](https://cip.tuik.gov.tr/).

## Installation

You can install the development version from [GitHub](https://github.com/emraher/tuikr) with:
...
**If you are having problems at this stage, please see this issue on [GitHub](https://github.com/emraher/tuikr/issues/2).**
